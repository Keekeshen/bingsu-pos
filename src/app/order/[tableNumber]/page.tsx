...
export default function TableOrderPage({
  ...
  async function submitOrder() {
    ...
    try {
      ...
      setCart([]);
      setShowCart(false);
      toast.success("Order sent! Keep adding more anytime.");
    } catch {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 pb-32">
        ...
        <div className="mx-auto max-w-lg px-4 py-4 flex items-center justify-between">
          ...
          {orderCount > 0 && (
            <div className="flex items-center gap-1.5 rounded-full bg-green-100 px-3 py-1 text-xs font-medium text-green-700">
              ...
              {orderCount} round{orderCount > 1 ? "s" : ""} ordered
            </div>
          )}
        </div>
      </header>
                        ...
                        {qty > 0 && (
                          <>
                            <button
                              ...
                              className="flex h-7 w-7 items-center justify-center rounded-full border border-zinc-200 text-zinc-600 hover:border-zinc-400 active:scale-95"
                            >
      ...
      {totalItems > 0 && !showCart && (
        ...
        >
          ...
          <span className="text-sm font-semibold">
            {totalItems} item{totalItems !== 1 ? "s" : ""} &middot; RM {totalPrice.toFixed(2)}
          </span>
        </button>
      )}
      ...
      {showCart && (
        ...
        >
          <div
            className="rounded-t-2xl bg-white p-4 max-h-[75vh] overflow-y-auto"
                ...
                >
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <button
                      ...
                      className="flex h-6 w-6 items-center justify-center rounded-full border border-zinc-200 text-zinc-600 active:scale-95"
                    >
